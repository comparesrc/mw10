...
/* 245 */       this.handle = new org.objectweb.asm.Handle(tag, this.handle.getOwner(), this.handle.getName(), this.handle.getDesc(), itf);
/*     */     }
/*     */ 
/*     */     
/*     */     public String getOwner() {
...
/* 256 */       this.handle = new org.objectweb.asm.Handle(this.handle.getTag(), owner, this.handle.getName(), this.handle.getDesc(), itf);
/*     */     }
/*     */ 
/*     */     
/*     */     public String getName() {
...
/* 267 */       this.handle = new org.objectweb.asm.Handle(this.handle.getTag(), this.handle.getOwner(), name, this.handle.getDesc(), itf);
/*     */     }
/*     */ 
/*     */     
/*     */     public String getDesc() {
...
/* 278 */       this.handle = new org.objectweb.asm.Handle(this.handle.getTag(), this.handle.getOwner(), this.handle.getName(), desc, itf);
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\DuduM\OneDrive\Área de Trabalho\mw10\modularwarfare-shining-2023.2.4.4f-fix10.jar!\org\spongepowered\asm\mixin\struct\MemberRef.class
