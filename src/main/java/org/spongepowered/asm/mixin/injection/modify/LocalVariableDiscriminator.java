...
/* 125 */       this.isStatic = Bytecode.isStatic(target.method);
...
/* 150 */         lvt[0] = new Local("this", Type.getObjectType(target.classNode.name));
/*     */       }
...
/* 160 */       Map<Type, Integer> ordinalMap = new HashMap<>();
...
/*     */     
/* 391 */     Set<String> names = new HashSet<>();
...
/* Location:              C:\Users\DuduM\OneDrive\Área de Trabalho\mw10\modularwarfare-shining-2023.2.4.4f-fix10.jar!\org\spongepowered\asm\mixin\injection\modify\LocalVariableDiscriminator.class
