...
/* 117 */     this.messager.printMessage(Diagnostic.Kind.WARNING, warning, element);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 127 */     this.messager.printMessage(Diagnostic.Kind.ERROR, error, element);
/*     */   }
/*     */   
/*     */   protected final Collection<TypeMirror> getMixinsTargeting(TypeMirror targetType) {
/* 131 */     return AnnotatedMixins.getMixinsForEnvironment(this.processingEnv).getMixinsTargeting(targetType);
/*     */   }
/*     */ }


/* Location:              C:\Users\DuduM\OneDrive\Área de Trabalho\mw10\modularwarfare-shining-2023.2.4.4f-fix10.jar!\org\spongepowered\tools\obfuscation\MixinValidator.class
