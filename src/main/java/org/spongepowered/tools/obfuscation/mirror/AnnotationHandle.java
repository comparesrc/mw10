...
/* 213 */     List<AnnotationHandle> annotations = new ArrayList<>(list.size());
...
/*     */     }
/*     */     
/* 236 */     List<T> unfolded = new ArrayList<>(list.size());
...
/* Location:              C:\Users\DuduM\OneDrive\Área de Trabalho\mw10\modularwarfare-shining-2023.2.4.4f-fix10.jar!\org\spongepowered\tools\obfuscation\mirror\AnnotationHandle.class
