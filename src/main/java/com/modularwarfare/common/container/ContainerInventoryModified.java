...
/* 194 */     if (clickTypeIn != ClickType.PICKUP && clickTypeIn != ClickType.QUICK_CRAFT && clickTypeIn != ClickType.THROW) {
/* 195 */       return ItemStack.field_190927_a;
/*     */     }
/* 197 */     return super.func_184996_a(slotId, dragType, clickTypeIn, player);
/*     */   }
/*     */ 
/*     */   
/*     */   public void func_75130_a(IInventory par1IInventory) {
/* 202 */     func_192389_a(this.thePlayer.func_130014_f_(), this.thePlayer, this.craftMatrix, this.craftResult);
/*     */   }
/*     */ 
/*     */   
/*     */   public void func_75134_a(EntityPlayer player) {
/* 207 */     super.func_75134_a(player);
/* 208 */     this.craftResult.func_174888_l();
/*     */     
/* 210 */     if (!player.field_70170_p.field_72995_K) {
/* 211 */       func_193327_a(player, player.field_70170_p, (IInventory)this.craftMatrix);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 222 */     ItemStack itemstack = ItemStack.field_190927_a;
/* 223 */     Slot slot = this.field_75151_b.get(index);
/*     */     
/* 225 */     if (slot != null && slot.func_75216_d()) {
/* 226 */       ItemStack itemstack1 = slot.func_75211_c();
/* 227 */       itemstack = itemstack1.func_77946_l();
/* 228 */       EntityEquipmentSlot entityequipmentslot = EntityLiving.func_184640_d(itemstack);
/*     */ 
/*     */       
/* 231 */       if (itemstack1.func_190926_b()) {
/* 232 */         slot.func_75215_d(ItemStack.field_190927_a);
/*     */       } else {
/* 234 */         slot.func_75218_e();
/*     */       } 
/*     */       
/* 237 */       if (itemstack1.func_190916_E() == itemstack.func_190916_E()) {
/* 238 */         return ItemStack.field_190927_a;
/*     */       }
/*     */       
/* 241 */       ItemStack itemstack2 = slot.func_190901_a(playerIn, itemstack1);
/*     */       
/* 243 */       if (index == 0) {
/* 244 */         playerIn.func_71019_a(itemstack2, false);
/*     */       }
/*     */     } 
/*     */     
...
/* 253 */     return (slot.field_75224_c != this.craftResult && super.func_94530_a(stack, slot));
/*     */   }
/*     */ }


/* Location:              C:\Users\DuduM\OneDrive\Área de Trabalho\mw10\modularwarfare-shining-2023.2.4.4f-fix10.jar!\com\modularwarfare\common\container\ContainerInventoryModified.class
