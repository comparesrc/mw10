...
/*     */                     
/* 226 */                     DamageSource damageSource = DamageSource.func_76365_a((EntityPlayer)entityPlayer).func_76349_b();
/*     */                     
/* 228 */                     if (bulletItem.type.isFireDamage) {
/* 229 */                       damageSource.func_76361_j();
/*     */                     }
/* 231 */                     if (bulletItem.type.isAbsoluteDamage) {
/* 232 */                       damageSource.func_151518_m();
/*     */                     }
/* 234 */                     if (bulletItem.type.isBypassesArmorDamage) {
/* 235 */                       damageSource.func_76348_h();
/*     */                     }
/* 237 */                     if (bulletItem.type.isExplosionDamage) {
/* 238 */                       damageSource.func_94540_d();
/*     */                     }
/* 240 */                     if (bulletItem.type.isMagicDamage) {
/* 241 */                       damageSource.func_82726_p();
/*     */                     }
/* 243 */                     if (!ModConfig.INSTANCE.shots.knockback_entity_damage) {
/* 244 */                       flag = RayUtil.attackEntityWithoutKnockback(target, damageSource, PacketExpGunFire.this.hitboxType.contains("head") ? (damage + itemGun.type.gunDamageHeadshotBonus) : damage);
/*     */                     } else {
/* 246 */                       flag = target.func_70097_a(damageSource, PacketExpGunFire.this.hitboxType.contains("head") ? (damage + itemGun.type.gunDamageHeadshotBonus) : damage);
/*     */                     } 
/* 248 */                     target.field_70172_ad = 0;
/* 249 */                     if (flag && 
/* 250 */                       plate != null) {
/* 251 */                       plate.func_96631_a(1, entityPlayer.func_70681_au(), entityPlayer);
/*     */                       
/* 253 */                       if (plate.func_77952_i() >= plate.func_77958_k()) {
/* 254 */                         extraSlots.setStackInSlot(1, ItemStack.field_190927_a);
/*     */                       } else {
/* 256 */                         extraSlots.setStackInSlot(1, plate);
/*     */                       } 
/*     */                     } 
/*     */ 
/*     */                     
/* 261 */                     if (entityPlayer instanceof EntityPlayerMP) {
/* 262 */                       ModularWarfare.NETWORK.sendTo(new PacketPlayHitmarker(PacketExpGunFire.this.hitboxType.contains("head")), entityPlayer);
/* 263 */                       ModularWarfare.NETWORK.sendTo(new PacketPlaySound(target.func_180425_c(), "flyby", 1.0F, 1.0F), (EntityPlayerMP)target);
/*     */                       
/* 265 */                       if (ModConfig.INSTANCE.hud.snap_fade_hit) {
/* 266 */                         ModularWarfare.NETWORK.sendTo(new PacketPlayerHit(), (EntityPlayerMP)target);
/*     */                       }
/*     */                     } 
/*     */                   } 
/*     */                 } else {
/*     */                   
/* 272 */                   BlockPos blockPos = new BlockPos(PacketExpGunFire.this.posX, PacketExpGunFire.this.posY, PacketExpGunFire.this.posZ);
/* 273 */                   ItemGun.playImpactSound(entityPlayer.field_70170_p, blockPos, itemGun.type);
/* 274 */                   itemGun.type.playSoundPos(blockPos, entityPlayer.field_70170_p, WeaponSoundType.Crack, (EntityPlayer)entityPlayer, 1.0F);
/* 275 */                   ItemGun.doHit(PacketExpGunFire.this.posX, PacketExpGunFire.this.posY, PacketExpGunFire.this.posZ, PacketExpGunFire.this.facing, (EntityPlayer)entityPlayer);
/*     */                 } 
/*     */               } 
/*     */             }
/*     */           }
